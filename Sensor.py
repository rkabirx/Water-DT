...
def w_i() :
    ...
    while True:
        ...
        button6 = tkinter.Button(master, text="Sense area 5", fg="blue", command=area5_ON)
        button6.grid(row=2, column=3)

        button7 = tkinter.Button(master, text="Sense area 6", fg="blue", command=area6_ON)
        button7.grid(row=3, column=1)

        button8 = tkinter.Button(master, text="Sense area 7", fg="blue", command=area7_ON)
        button8.grid(row=3, column=2)

        button9 = tkinter.Button(master, text="Sense area 8", fg="blue", command=area8_ON)
